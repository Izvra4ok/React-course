...
import mod from "./FriendsOnline.module.css";
import FriendAva from "../Friend/FriendAva/FriendAva";
        ...
        <div className={mod.about_friend}>
            ...
            <div>
                ...
                <div className={mod.friend_links}>
                    {props.ava}
                    <span><NavLink to={"write" + props.first + props.last} className={mod.friend_link}>Write message</NavLink></span>
                    <span><NavLink to={"call" + props.first + props.last} className={mod.friend_link}>Call</NavLink></span>
                </div>
            </div>
